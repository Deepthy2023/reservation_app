...
class _PassengerWidgetState extends State<PassengerWidget> {
  ...
  TextEditingController passengerGender = TextEditingController();
                      ...
                      itemBuilder: (context, index) {
                        return Container(
                          decoration: const BoxDecoration(
                              color: Color.fromARGB(255, 212, 163, 106),
                              border: Border(
                          ...
                          child: InkWell(
                            onTap: () {
                              ...
                              passengerGender.text =
                                  passengerList[index].passengerGender ?? "";
                              passengerMob.text =
  ...
  Future<void> saveRecord() async {
    try {
      Map<String, dynamic> body = {
        ...
        'passenger_gender': passengerGender.text,
    ...
    try {
      ...
      if (msg.toLowerCase().contains("success")) {
        ...
        jsonData.forEach((jsonItem) {
          ...
          passenger.passengerGender = jsonItem['passenger_gender'];
